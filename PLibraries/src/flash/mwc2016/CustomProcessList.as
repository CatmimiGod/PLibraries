package flash.mwc2016
{
	 ...
	 * 
	 */	
	public final class CustomProcessList
	{
		//配置
		 ...
		 */		
		public function CustomProcessList(processList:XML = null)
		{
			loaderList(processList);
		}
		 ...
		 * @param processList
		 */		
		public function loaderList(processList:XML):void
		{
			if(processList == null)		return;
			
			if(processList.children().length() > 0)
			{
				//if(_process && _process.running)	_process.exit();
